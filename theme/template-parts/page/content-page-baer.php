	...
	<nav class='header-menu'>
	  ...
	  <div class='float-container'>
	    <ul class='inline-block-container L-1-1'>
	      <li>Daniel Baer for <?php the_title(); ?>:<!-- Client Name --></li>
...
<article id="page-<?php the_ID(); ?>" class='baer'>

	<!-- Loader --> 
	<div class='loader'>
	  <div class='loading L-1-1 float-container'>
	    <div class=''>
	      Daniel Baer for <?php the_title() ?>
	    </div>
	    <div class="arrows">
	        ...
	        <section class='section video'>
	        	<div class='trunk float-container'>
		        	<div class="video-wrapper S-1-1">
				        <video width="100%" class='shadow' loop poster='<?php echo $bigimage ?>'>
